...
class RegisterViewController: UIViewController {
    ...
    @IBAction func regBtnClick(_ sender: Any) {
        if (usrNameFld.text!.replacingOccurrences(of: " ", with: "") == ""){
            let alertView = UIAlertController(title: "Unsuccessful registration", message: "Error: Username field cannot be empty", preferredStyle: UIAlertController.Style.alert)
            alertView.addAction(UIAlertAction(title: "Back", style: UIAlertAction.Style.default, handler: { _ in
            }))
